...
//			AES_UnWRAP(EapolKeyMsgRecvd.Octet + KeyDataPos, keylen + 8, kek, keklen, tmp2);
		...
		AES_UnWRAP(EapolKeyMsgRecvd.Octet + KeyDataPos, Message_KeyDataLength(EapolKeyMsgRecvd), kek, keklen, tmp2);
//------------------------- 2005-08-01
...
//--------------------------------------------------------- david+2006-04-06
		...
		set_connect_sta_info(priv, pstat->hwaddr, STA_CONNECT_4_WAY_TIME_OUT);
...
#endif
			set_connect_sta_info(priv, pstat->hwaddr, STA_CONNECT_SUCCESS);
...
#if (SUPPORT_FAST_CONFIG == R1KH_NORMAL_PUSH_PULL)
		/*  not found r1KH
